...
function business_del(id){
    ...
    router.delete(route('business.destroy', url_param), request_data);
                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                            <div class="lg:w-1/2 md:w-1/2 sm:w-1/3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="relative w-1/2 mt-1">
                                        ...
                                        <input type="text" v-model="search" id="business_search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search">
                                    </div>
                                    <div class="relative w-1/2">
                                        <SelectInput
                                            ...
                                            nameProp="name"
                                            default_option="Filter Business type"
                                        />
                                    </div>
                                </div>
                            </div>
                            <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                <FadeTransition>
                                    <button v-if="check_del" type="button" @click="business_del(checked)" class="flex items-center justify-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-700 dark:hover:bg-red-800 focus:outline-none dark:focus:ring-red-800">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr v-for="(business, index) in businesses.data" class="text-center border-b dark:border-gray-700" :key="business.id">
                                        ...
                                        <th class="px-6 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ business.name }}</th>
                                        ...
                                        <td class="px-6 py-3 flex items-center gap-2 justify-center">
                                            ...
                                            <button @click="_confirm_modal_open(business)" class="text-red-500 hover:text-red-800 rounded-lg focus:outline-none dark:text-red-500 dark:hover:text-red-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
